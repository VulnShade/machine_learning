...
def load_data():
    ...
    item_train = genfromtxt('utils/data/content_item_train.csv', delimiter=',')
    user_train = genfromtxt('utils/data/content_user_train.csv', delimiter=',')
    y_train    = genfromtxt('utils/data/content_y_train.csv', delimiter=',')
    with open('utils/data/content_item_train_header.txt', newline='') as f:    #csv reader handles quoted strings better
        item_features = list(csv.reader(f))[0]
    with open('utils/data/content_user_train_header.txt', newline='') as f:
        user_features = list(csv.reader(f))[0]
    item_vecs = genfromtxt('utils/data/content_item_vecs.csv', delimiter=',')

    movie_dict = defaultdict(dict)
    count = 0
#    with open('utils/data/movies.csv', newline='') as csvfile:
    with open('utils/data/content_movie_list.csv', newline='') as csvfile:
    ...
    with open('utils/data/content_user_to_genre.pickle', 'rb') as f:
